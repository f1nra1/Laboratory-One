...
**Цель работы:**
Иучение основ работы с Git и GitHub, а также разработка алгоритмов для вычисления параметров геометрических фигур.
...
LabaOneArtem.cpp - исходный код программы.
